...
function Notification({ className }) {
  ...
  useEffect(() => {
    const getInformation = async () => {
      await axios.get(process.env.REACT_APP_BACKEND+"/information/getCovid")
        .then((res) => {
  ...
  useEffect(() => {
    const getWeather = async () => {
      await axios.get(process.env.REACT_APP_BACKEND+"/information/getWeather")
        .then((res) => {
          setWeather(res.data);
        })
        .catch(() => {
  ...
  useEffect(() => {
    const getGold = async () => {
      await axios.get(process.env.REACT_APP_BACKEND+"/information/getGold")
        .then((res) => {
